...
// "platforms": [
//     {
//            "platform": "IndigoDomotics",
//            "name": "IndigoDomotics",
//            "host": "PUT IP ADDRESS OF YOUR INDIGO SERVER HERE",
//            "port": "PUT PORT OF YOUR INDIGO SERVER HERE",
//            "username": "PUT USERNAME OF YOUR INDIGO SERVER HERE",
//            "password": "PUT PASSWORD OF YOUR INDIGO SERVER HERE"
//     }
// ],
//
...
function IndigoDomoticsPlatform(log, config){
  this.log = log;
  this.host = config["host"];
  this.port = config["port"] || "8176";
...
IndigoDomoticsPlatform.prototype = {
  accessories: function(callback) {
    this.log("Fetching Indigo devices...");
...
function IndigoDomoticsAccessory(controlService, characteristics) {
...
module.exports.platform = IndigoDomoticsPlatform;
